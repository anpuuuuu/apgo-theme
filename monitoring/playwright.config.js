...
const storefrontChromeUa = devices['Desktop Chrome'].userAgent;
...
const v2Projects = [
  ...
  },
  {
    ...
    use: {
      ...devices['Pixel 7'],
      browserName: 'chromium',
      // Exercise the real Pixel viewport/touch layout while keeping the HTTP
      // fingerprint version-matched to the installed browser. Exact social
      // mobile UAs are covered separately by the WebView projects.
...
module.exports = defineConfig({
  ...
  use: {
    headless: true,
    viewport: { width: 1366, height: 900 },
    /* Keep the HTTP UA browser-shaped and version-matched to the Chromium
       binary. A pinned older Chrome UA can disagree with TLS/client hints and
       look synthetic to an edge bot detector. The fixture appends the health
       marker only inside the page, after the storefront document is loaded. */
    userAgent: storefrontChromeUa,
